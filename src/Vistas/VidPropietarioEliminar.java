 ...
 * @author sebastian
 */
public class VidPropietarioEliminar extends javax.swing.JFrame {

    int My;
    int Mx;

    public VidPropietarioEliminar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Titulo.setText("C.C. del Propietario a Eliminar");
    ...
    private void txt_IdMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txt_IdMousePressed
        if (txt_Id.getText().equals("Cédula")) {
            txt_Id.setText("");
    ...
    private void lbl_VolverMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_VolverMouseExited
        pnl_Volver.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_VolverMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_VolverMouseEntered
        ...
        pnl_Volver.setBackground(new Color(70, 181, 255));
    ...
    private void lbl_EliminarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_EliminarMouseEntered
        pnl_ingresar.setBackground(new Color(70, 181, 255));
    ...
    private void lbl_EliminarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_EliminarMouseExited
        pnl_ingresar.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_EliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_EliminarMouseClicked
        if (txt_Id.getText().isEmpty()||txt_Id.getText().equals("Cédula")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VidPropietarioEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VidPropietarioEliminar().setVisible(true);
            }
        });
    }
